...
export interface PopularModel { id: string; family?: string | null; size_gb?: number | null; params: string; description: string; tags: string[]; recommended: boolean; installed: boolean; }
